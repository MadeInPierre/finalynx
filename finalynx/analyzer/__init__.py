...
- Asset class allocation for the selected folder
- A fund availability allocation (e.g. lines in a PER are unavailable until an event "retirement"
or "buy house" is triggered, lines in a PEA are blocked for 5 years, AV will have a highly taxed
state instead of blocked, ...). This graph would show how much money would be available when.
